...
export name='bielvelozo'
export email="gabrielvelozodev@gmail.com"
export repositorio="https://github.com/bielvelozo/Gabriel-Velozo.git";
...
git init
git remote add origin "https://github.com/bielvelozo/Gabriel-Velozo.git"
